...
IngotsStorage = $4009FBC6; // Chest in the house in which to throw the chopped. 

HomeRuneBook = $4007AE5A; // Runabuki ID srnukoy in the house. 
HomeRuneIndex = 0; // position of the runes to the house in runabuka. 0 - the first fleece. 
RuneBookShift = 50; // 7 - chiva, 5 magic. 
HomeX = 931; // Coordinate X in front of the chest in the house. 
